...
public class UserTemplateRepository implements UserRepository{
    ...
    public AppUser create(AppUser user) {
        final String sql = "INSERT INTO library_users (first_name, last_name, username, password_hash, email, role_id) "
                + "VALUES (?, ?, ?, ?, ?, ?);";
    ...
    public AppUser update(AppUser user) {
        final String sql = "UPDATE library_users SET "
                + "first_name = ?, "
                + "last_name = ?, "
                + "username = ?, "
                + "password_hash = ?, "
    ...
    public boolean deleteById(Integer userId) {
        final String sql = "DELETE FROM library_users WHERE user_id = ?;";
